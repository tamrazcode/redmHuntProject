Config = {
  ...
  -- 1000 units: food lasts 90 min, water 75 min at rest (real time).
  EveryTimeStatusDown = 3600,
  HowAmountThirstWhileRunning = 0.84, -- +5% rate during Shift running; no keypress cost
  HowAmountHungerWhileRunning = 2 / 3,
  HowAmountThirst = 0.8,
  HowAmountHunger = 2 / 3,
  ColdHungerMultiplier = 1.5, -- maximum +50% food use at 100% cold
  HeatThirstMultiplier = 1.5, -- maximum +50% water use at 100% heat
  ...
  ItemsToUse = {
    {
      ...
      InnerCoreHealthGold = 0,              -- Effect on the player's inner core gold stamina.
      OuterCoreHealthGold = 0,              -- Effect on the player's outer core gold stamina.
      InnerCoreStaminaGold = 0,             -- Effect on the player's inner core gold stamina.
      OuterCoreStaminaGold = 0,             -- Effect on the player's outer core gold stamina.
