...
Config = {
    ...
    ShowUIWhenDead           = false,        -- when player dies the notifications or any game UI will be visible.

    DisableDeathAudioScene   = false,        -- Enables the game sounds when player is death

    DisableRemoteAttachments = true,         -- disables players attaching props to other players (used by cheaters)
    ...
    HealthRecharge           = { enable = false, multiplier = 0.0 }, -- Auto-recharge for health disabled.
    ...
    UseDeathHandler          = false,                                -- HUNT: handled by thehunt_death.
