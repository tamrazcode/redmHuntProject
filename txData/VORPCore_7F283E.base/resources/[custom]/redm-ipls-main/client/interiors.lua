...
CreateThread(function()
    while not isLoaded do
        ...
        if IsValidInterior(4610) then
            DeactivateInteriorEntitySet(
                4610,
                "han_int_tables_flipped"
            )
...
RegisterCommand("han1", function()
    local interior = 4610

    if not IsValidInterior(interior) then
        print("Hanging Dog interior isn't valid")
        return
    end

    ActivateInteriorEntitySet(interior, "l_000032d4et")
    print("HAN: l_000032d4et ON")
end)

RegisterCommand("han2", function()
    local interior = 4610
    ...
    ActivateInteriorEntitySet(interior, "l_00283f5evy")
    print("HAN: l_00283f5evy ON")
end)

RegisterCommand("hanclear", function()
    local interior = 4610
    ...
    DeactivateInteriorEntitySet(interior, "l_000032d4et")
    DeactivateInteriorEntitySet(interior, "l_00283f5evy")
    DeactivateInteriorEntitySet(interior, "han_int_tables_flipped")

    ActivateInteriorEntitySet(interior, "han_int_tables_upright")

    print("HAN: clean baseline")
end)
