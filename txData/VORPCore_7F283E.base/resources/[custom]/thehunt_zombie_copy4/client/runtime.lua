...
function ZC.configure(ped,settings,initial,weapon)
    ...
    SetPedCombatAttributes(ped, 1, false) -- without vehicle
    ...
    SetPedCombatAttributes(ped, 71, false) -- CA_CAN_USE_MELEE_TAKEDOWNS = false (Allows standard blockable melee strikes instead of unblockable tackles)
